...
\begin{frame}{\\}
	...
	\scnrelfrom{пояснение}{формализация понятий, т.е. выделение абсолютных и относительных понятий, связей}
	
	\scnheader{построение онтологии}
	\scnrelfrom{пояснение}{выделение и формализация теоретико-множественных связей, свойств отношений, доменов, логических закономерностей и определений}
