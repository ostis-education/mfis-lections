	...
	\begin{SCn}
		...
		\begin{scnindent}
			\begin{scnrelfromset}{используемые понятия}
				...
				\begin{scnindent}
					\scnsuperset{понятия, на основе которых определяется данное понятие*}
					\scnsuperset{понятия, которые определяются на основе данного понятия*}	
				\end{scnindent}
...
\begin{frame}{\\Пример онтологий}
	...
	\vspace{10mm}
	\begin{figure}[H]
		\includegraphics[scale=0.8]{./figures/sd_ontologies/ontology2.png}
	\end{figure}
\end{frame}
...
\begin{frame}{\\Пример онтологии}
	...
	\vspace{10mm}
	\begin{figure}[H]
		\includegraphics[scale=0.7]{./figures/sd_ontologies/ontology3.png}
	\end{figure}
\end{frame}
