...
\title{Lecture 1 \\Basic Provisions of Semantic Technology for Designing New Generation Intelligent Computer Systems \vspace {-2em}}
...
% 	\topline
% 	\justifying
% 		Intelligent system, complex task, hybrid intelligent system.
% 		Basic principles of semantic technology for designing new generation intelligent computer systems.
% 		The main components of the specified technology.
% 		Information construction, formal language, sign, syntax, semantics.
% 		Semantic memory.
%\end{frame}
...
\begin{SCn}
	...
	\footnotesize
	\scnheader{cybernetic system}
	\scnrelfrom {partition}{A sign of the naturalness or artificiality of cybernetic systems}
	\begin{scnindent}
	\begin{scneqtoset}
				...
				\scnfileitem{The OSTIS problem solver is based on a multi-agent approach and allows you to easily \underline{combine any problem-solving models}
					...
					\begin{frame}{\\}	
						...
						\begin{SCn}
							...
							\scnfileitem{unification of presentation (any information is presented \underline {the same})}
									...
									\begin{frame}{\\}
										...
										\begin{SCn}	
											\scnheader{base knowledge of the ostis system
												...
												\scntext {clarification}{The interface of the ostis system can also be described in SC code}
												\end{SCn}
												\end{frame}
