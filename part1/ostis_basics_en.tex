...
\justifying
\begin{SCn}
\scnheader{informational structure}
\scnidtf{a structureion (structure) containing some information about some entities}	
\scnidtf{information}
\scntext{note}{The information structure has
\begin{textitemize}
...
\begin{scnrelfromset}{subdividing}
	...
	\begin{scnindent}
		\scnidtf{internal information structure of the ostis-system, stored in its (internal) sc-memory}
	\end{scnindent}
	\scnitem{file}
	\begin{scnindent}
		\scnidtf{internal information structure of the ostis-system, stored in its file (external) memory}
		\scntext{note}{the file may be stored in another system's memory}
	\end{scnindent}
	\scnitem{external information structure that is neither a file nor an sc-structure}
\end{scnrelfromset}
\scnsuperset{discrete information structure}
\end{SCn}
\end{frame}
...
\begin{SCn}
	\small
	\scnheader{discrete information structure}
	\scntext{explanation}{Each discrete information structure is an information structure whose meaning is given by:
	\begin{textitemize}
		\item set of elements (syntactically atomic fragments) of this information structureion
...
\begin{SCn}
\scnheader{language}
\scnidtf{a set of informational structureions built according to common syntactic and semantic rules}
\begin{scnrelfromset}{subdividing}
...
\scnidtf{a set of structureions composed of some finite alphabet of a language}		
\end{SCn}
\end{frame}
...
\begin{SCn}
	\scnheader{sign}
	\scnidtf{a fragment of an informational structure that has the property of \underline{designating} some entity (object), which, along with other entities, is described by the specified informational structure}
	
	\begin{scnrelfromset}{subdividing}
		\scnitem{a sign that is an element of \textit{a discrete information structure}}
		\scnitem{a sign that is a non-atomic fragment of \textit{a discrete information structure}}
	\end{scnrelfromset}
...
By \textbf{\textit{sign}} we mean a fragment of \textit{information structure}, which conventionally represents (denotes) some described entity, which is called \textbf{\textit{denotate of the sign}}.
...
\begin{SCn}
	...
	\begin{scnrelfromset}{components}
		\scnitem{Syntax (studies the correct structureion of text)}
