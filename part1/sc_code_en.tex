...
\item The alphabet used to represent data and commands is the set \{0, 1\}
\item each program consists of a set of instructions executed by the processor sequentially
\item It is possible that conditional jump commands may be present in programs
\end{textitemize}
\end{frame}
...
\begin{column}{0.4\textwidth}
	...
	\begin{textitemize}		
		\item is inconvenient for a person
...
\begin{SCn}
\scnheader{SC-code}
\scnidtf{an abstract language that resides in the memory of a computer system}
...
\begin{frame}{\\Basic Provisions of the SC-code}
\topline
\justifying
\vspace{8mm}
\begin{SCn}
...
\begin{scnrelfromset}{basic provisions}
	...
	\scnfileitem{SC-code texts have a nonlinear structure, since each entity symbol is included in the knowledge base only once and has an unlimited number of connections with other entity symbols}
\end{scnrelfromset}
\end{SCn}
\end{frame}
...
\begin{frame}{\\Cyntax. SC-code alphabet}
\topline
\justifying
\begin{SCn}
...
\begin{textitemize}
	...
	\item{carrying out constant positive sc-pairs of membership into all sc-elements that are elements
		allocated sc-class and stored (present) in the current state of sc-memory.}
\end{textitemize}
...
\begin{frame}{\\SC Core Code Alphabet}
\topline
\justifying
\begin{SCn}
\begin{columns}[T,onlytextwidth]
	\begin{column}{0.7\textwidth}
		\vspace{5mm}
		\scnheader{SC Core Code Alphabet}
		\begin{scneqtoset}
			\scnitem{sc-node, which is a file sign}
			\scnitem{sc-node that is not a file mark}
...
\scnheader{sc-node not a file sign}
...
\scnrelfrom{partition}{Structural feature of classification of sc-elements}
\begin{scnindent}
	\begin{scneqtoset}
		\scnitem{sc-set notation}
		\scnitem{designation of an external entity}
		\begin{scnindent}
...
\begin{scnrelfromset}{partition}
	...
	\begin{scnindent}
		\begin{scnrelfromset}{partition}
			...
			\begin{scnindent}
				\begin{scnrelfromset}{partition}
					\scnitem{notation for an unoriented sc-pair}
					\scnitem{designation of an oriented sc-pair}
				\end{scnrelfromset}
			\end{scnindent}
			\scnitem{a notation for an sc-connection that is neither a singleton nor a pair}
		\end{scnrelfromset}
	\end{scnindent}
	scnitem{sc-class designation}
	scnitem {sc-structure notation}
\end{scnrelfromset}
\end{SCn}
\end{frame}
...
\justifying
\begin{SCn}
\scnheader{designation of an oriented sc-pair}
\begin{scnrelfromset}{partition}
	\scnitem{designation of the sc-pair of belonging}
	\begin{scnindent}
		\begin{scnrelfromset}{partition}
			\scnitem{designation of a fuzzy membership sc-pair}
			\scnitem{designation of a sc-pair of positive membership}
			\scnitem{designation of a sc-pair of negative affiliation}
		\end{scnrelfromset}
	\end{scnindent}
...
scnstartstruct
scnheader{sc-element}
\scnrelfrom{partition}{A sign of the constant existence of entities designated by sc-elements}
\begin{scnindent}
	\begin{scneqtoset}
		\scnitem{designation of a constant entity}
		\begin{scnindent}
			\scnidtf{designation of a permanently existing entity}
		\end{scnindent}
		\scnitem{designation of a temporary entity}
	\end{scneqtoset}
\end{scnindent}
\scnendstruct
\end{SCn}
...
\begin{frame}{\\Static entity flag}%Possibly redundant
\topline
\justifying
\begin{SCn}
scnheader{sc-element}
\scnrelfrom{partition}{Staticity indicator for entities denoted by sc-elements}
\begin{scnindent}
	\begin{scneqtoset}
		\scnitem{static entity designation}
		\begin{scnindent}
			\scnidtf{designation of an entity, changes to which within the relevant period of time are considered immaterial}
...
\begin{scnrelfromset}{partition}
	...
	\begin{scnindent}
		\scnsuperset{designation of the external situation}
		\scnsuperset{external event designator}
...
\vspace{10mm}
\begin{SCn}
\textbf{When talking about the temporal properties of sc-elements, one should clearly distinguish:}
\begin{textitemize}
...
\begin{scnrelfromset}{partition}
	...
	\begin{scnindent}
		\begin{scnrelfromset}{partition}
			\scnitem{sc-pair of belonging}
			\begin{scnindent}
				\begin{scnrelfromset}{partition}
					\scnitem{sc-fuzzy membership pair}
					\scnitem{sc-pair of positive affiliation}
					\scnitem{sc-pair of negative affiliation}
				\end{scnrelfromset}
			\end{scnindent}
