...
\begin{frame}{\\Классификация по темпоральным характеристикам}%Возможно лишнее
\begin{SCn}
...
\begin{frame}{\\Обозначение внутренней временной сущности в sc-памяти}%Возможно лишнее
	\begin{SCn}
