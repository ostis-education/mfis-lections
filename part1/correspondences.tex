...
\begin{frame}{\\Однозначное соответствие}
    ...
    \begin{center}
        \begin{figure}[Hb]
            \centering
            \includegraphics[scale=.72]{figures/Однозначное соответствие.png}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{\\Неоднозначное соответствие}
    ...
    \begin{center}
        \begin{figure}[Hb]
            \centering
            \includegraphics[scale=.72]{figures/Неоднозначное соответствие.png}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{\\Отображение}
    ...
    \begin{center}
        \begin{figure}[Hb]
            \centering
            \includegraphics[scale=.45]{figures/Отображение.jpeg}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{\\Биективное соответствие}
    ...
    \begin{center}
        \begin{figure}[Hb]
            \centering
            \includegraphics[scale=.45]{figures/Биекция.jpeg}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{\\Гомоморфизм}
    ...
    \begin{center}
        \begin{figure}[b]
            \centering
            \includegraphics[scale=.45]{figures/Гомоморфизм.png}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{\\Изоморфизм}
    ...
    \begin{center}
        \begin{figure}[b]
            \centering
            \includegraphics[scale=.5]{figures/Изоморфизм.png}
        \end{figure}
    \end{center}
\end{frame}
...
\begin{frame}{\\Автоморфизм}
    ...
    \begin{center}
        \begin{figure}[b]
            \centering
            \includegraphics[scale=.55]{figures/Автоморфизм.png}
        \end{figure}
    \end{center}
\end{frame}
