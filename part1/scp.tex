...
\begin{frame}{\\Пример описания scp-переменных}%sc-константа
	\topline
	\justifying
...
\begin{frame}{Пример описания scp-оператора \\генерации одноэлементной конструкции (genEl)}
	\topline
	\justifying
	
\end{frame}

\begin{frame}{Пример описания scp-оператора \\генерации трёхэлементной конструкции (genElStr3)}
	\topline
	\justifying
	
\end{frame}

\begin{frame}{Пример выполнения scp-оператора \\поиска трёхэлементной конструкции (searchElStr3)}
	\topline
	\justifying
...
\begin{frame}{\\Параллельное выполнение scp-операторов}
	\topline
	\justifying
...
\begin{frame}{\\Принципы интерпретации scp-программ}
	\topline
	\justifying
...
\begin{frame}{\\Организация циклов}
	\topline
	\justifying
	
\end{frame}

\begin{frame}{\\Копирование множества}
	\topline
	\justifying
